...
import { Button, Card, CardContent, CardActions, Box, Typography, Table, TableCell, TableContainer, TableRow, TableHead, Paper, TableBody } from "@mui/material";
...
const CardDetail = ({ data }) => {
  return (
    <Box sx={{ minWidth: 325 }} style={{ position: "absolute", top: 10, left: 20, zIndex: 104 }}>
      <Card>
        <CardContent>
                  ...
                  data.map((d) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">{d.properties.color}</TableCell>
                        <TableCell align="right">{distance.toLocaleString()}</TableCell>
                        <Button value={d.properties._id} onClick={e => deleteStudent(e)} variant="contained" style={{ float: "center", textTransform: "capitalize", fontSize: "10px"}}>Hapus</Button>
                      </TableRow>
                    );
                  })}
              </TableBody>
...
const MapBox = ({ children, mapStyle = "mapbox://styles/mapbox/streets-v11", height }) => {
  ...
  return (
    <ReactMapGL
      {...viewport}
      height={height}
      mapboxAccessToken={"pk.eyJ1Ijoidm9uaXNzYWMiLCJhIjoiY2w1MHVqZzlvMDh0bjNsb2hyZTBoenE1aSJ9.j-_W1GMSLdpsBj7MJ9_JhA"}
      mapStyle={mapStyle}
      onDrag={(e) =>
        setViewport({
          ...viewport,
